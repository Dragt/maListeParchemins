    ...
    class Parchemin {
        ...
        constructor(id, nom=undefined, effetDeBaseTexte=undefined, glyphes=[], dateEnregistrement=new Date(), etat=EN_COURS ) {
            this.id = id;
            this.nom = nom;
    ...
    class ParcheminEnPage extends Parchemin {
        ...
        constructor(id, nom, effetDeBaseTexte, glyphes, affiche=true, qualite=QUALITE_NEUTRE, etat) {
            super(id, nom, effetDeBaseTexte, glyphes, etat);
...
Après la recherche des glyphes d'un parchemin, le champ est mis à jour automatiquement avec le numéro du prochain parchemin de la liste.`]]
    ...
    Tour => 15 min">`;
            ...
            html += `<select style="margin:5px; padding:3px" id="caracRecherche" name="caracRecherche" 
              title=" Toutes caracs : signifie que l'outil va garder la carac la plus élevée (ou la plus basse), 
